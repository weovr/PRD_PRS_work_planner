"""
Scenario 02 — Boreskopinspeksjon GT-4201, Gullfaks C

Brukeren ber om planlegging av boreskopinspeksjon på gassturbinen.
Agenten bestemmer selv hva som må sjekkes og koordineres.

Kjør: python scenarios/scenario_02_gt_inspection.py
"""
...
def main():
    print("=" * 66)
    print("  EQUINOR — Scenario 02: Boreskopinspeksjon GT-4201, Gullfaks C")
    print("=" * 66)

    forespørsel = (
        "Planlegg boreskopinspeksjon på GT-4201 på Gullfaks C. "
        "Sjekk turbinens driftstimestatus og siste overhaul. "
        "Hvem kontakter vi hos Siemens Energy, og hva er mob-fristen? "
        "Sjekk også om bemanningen på Gullfaks C har gyldige sertifikater."
    )
